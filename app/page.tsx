                        ...
                        <div className="flex justify-around px-6 py-8 pb-20">
                            {[
                                ...
                                <Card
                                    ...
                                    className={`relative cursor-pointer w-60 h-80 overflow-hidden rounded-md transition-all duration-300 ${
                                        selectedZone === zone ? "bg-white border-blue-300 shadow-lg" : "bg-gray-100 bg-opacity-60"
                                    }`}
                                >
                                    <CardContent className="p-0 h-full relative group">
                                        <img
                                            ...
                                            className={`w-full h-full object-cover transition-opacity duration-300  ${
                                                selectedZone === zone ? "opacity-30" : "opacity-100"
                                            }`}
                                        />

                                        <div
                                            className={`absolute inset-0 flex items-center justify-center bg-opacity-10 ${
                                                selectedZone === zone ? "bg-white" : "bg-white bg-opacity-60"
